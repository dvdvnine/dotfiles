-- NOTE: from https://github.com/nvim-mini/MiniMax/blob/main/configs/nvim-0.12/plugin/30_mini.lua.
...
later(function()
  ...
  vim.api.nvim_set_hl(0, "MiniHipatternsSection", { link = "MiniHipatternsNote" })
  ...
  hipatterns.setup({
    highlighters = {
      ...
      section = hi_words({ "SECTION", "Section", "section" }, "MiniHipatternsSection"),
